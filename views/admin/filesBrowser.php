...
<div class="row">
		...
		<table class="table table-hover" id="fTable">
			...
			<?php foreach($files as $file): ?>
				<tr>
					...
					<td>
						<a href="<?php echo $file['fname']; ?>"><?php echo $file['fname']; ?></a>
					</td>
					<td>
						<?php echo $file['size']; ?>
					</td>
	...
	<div class="col-lg-3">
		<div class="panel panel-primary overflow-hidden">
			<div class="panel-heading">Upload (max 30 files, 100Mb)</div>
			<div class="panel-body" id="fi">
				<?php $form = ActiveForm::begin(['options' => ['enctype' => 'multipart/form-data']]); ?>
				<?= $form->field($model, 'file[]')->fileInput(['multiple' => true])->label(false) ?>
				<!-- <button class="btn btn-primary">Upload</button> -->
				<?php ActiveForm::end(); ?>
				<button class="btn btn-primary" id="btn-send">Upload</button>
				<div id="fi-state"></div>
			</div>
		</div>
	</div>
